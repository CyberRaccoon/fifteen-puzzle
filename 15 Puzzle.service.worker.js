...
/** @type {string} */
const CACHE_VERSION = '1767570737|318721565';
/** @type {string} */
const CACHE_PREFIX = '15 Puzzle-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = '15 Puzzle.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["15 Puzzle.html","15 Puzzle.js","15 Puzzle.offline.html","15 Puzzle.icon.png","15 Puzzle.apple-touch-icon.png","15 Puzzle.audio.worklet.js","15 Puzzle.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["15 Puzzle.wasm","15 Puzzle.pck"];
